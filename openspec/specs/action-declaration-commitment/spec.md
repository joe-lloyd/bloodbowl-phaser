# action-declaration-commitment

## Purpose

Defer once-per-turn action commitment so a declared action does not spend the team's allowance until it becomes binding, and let the coach change their mind on an uncommitted declaration without cost.
