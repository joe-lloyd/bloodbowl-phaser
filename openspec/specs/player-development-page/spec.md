...
Give every player a durable development page in Manage Team — characteristics, injuries, skills, SPP, career statistics, and provenance — and make it the only place standard SPP advancement is actually applied, including development left pending after a match.
