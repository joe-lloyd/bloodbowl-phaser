...
Defines the canonical catalog of Blood Bowl skills and traits: how catalog entries map to the 2025 rulebook, how parameterized skill families are represented, how legacy skill names migrate, and what book metadata each entry carries for display.
