...
The board-label overlay fades and scales in response to camera state changes instead of remaining fixed on screen, so end-zone team names and dugout labels don't hang motionless over a zoomed pitch.
