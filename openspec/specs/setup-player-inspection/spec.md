...
Player information is available while placing players during setup, so a coach can tell who they are dragging or selecting instead of setup being the one phase where the info panel goes blank.
