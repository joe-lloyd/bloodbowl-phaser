...
Preserve in-progress local matches across refreshes and devices through deterministic local autosaves, optional signed-in cloud synchronization, and a clear resume flow.
