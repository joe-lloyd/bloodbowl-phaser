...
Bridge competitions (leagues and tournaments) with match play: launch fixtures locally or hosted, carry competition context through the match, and record results back to update standings/brackets and persist progression.
