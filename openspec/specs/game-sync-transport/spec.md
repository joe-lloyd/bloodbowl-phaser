...
The host SHALL be able to send a resync envelope containing a full game snapshot plus the current pending decision. On receipt the guest SHALL rebuild its entire view from that snapshot rather than replaying prior events.
