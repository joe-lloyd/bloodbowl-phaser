...
## Purpose
Defines selectable visual themes for the pitch while preserving gameplay geometry and synchronizing the chosen presentation across local and online matches.
