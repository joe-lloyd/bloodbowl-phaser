...
Give the two players in an online match a text chat channel that shares the dice-roller panel with the dice log, relays through the same match message stream as game commands, is available regardless of turn ownership, and signals unread messages.
