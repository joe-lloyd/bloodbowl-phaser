...
A large, centred announcement reserved for turn changes, round flips, halftime, and full time, acting as a bookend to each part of the match rather than another notification competing with routine outcomes.
