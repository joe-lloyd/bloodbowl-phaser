...
Derive a team's draft/active lifecycle from its first completed match, enforce one shared roster-legality validator and one edit/pricing service across every entry point (Team Builder, Team Management, match selection, competition entry), and keep the team builder readable at the application's normal body-text scale.
