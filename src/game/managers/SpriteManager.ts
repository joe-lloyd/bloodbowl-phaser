...
export class SpriteManager {
     ...
     */
    public placePlayersOnPitch(team1: Team, team2: Team, onPlayerClick?: (player: Player) => void): void {
        ...
        allPlayers.forEach(player => {
            ...
            if (this.playerSprites.has(player.id)) {
                ...
                const sprite = new PlayerSprite(this.scene, pos.x, pos.y, player, teamColor, team.rosterName);
                sprite.setDepth(10);
