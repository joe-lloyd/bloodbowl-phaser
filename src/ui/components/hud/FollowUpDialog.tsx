...
export const FollowUpDialog: React.FC<FollowUpDialogProps> = ({ eventBus }) => {
  ...
  useEffect(() => {
    ...
    eventBus.on(GameEventNames.UI_FollowUpPrompt, onFollowUpPrompt);

    return () => {
      eventBus.off(GameEventNames.UI_FollowUpPrompt, onFollowUpPrompt);
    };
  }, [eventBus]);
