            ...
            <ContentContainer>
                ...
                <div className="bg-white/90 rounded-lg p-8 shadow-md my-5">
                    ...
                    <div className="mt-5 p-4 bg-gray-50 rounded border-l-4 border-blood-bowl-primary min-h-[200px] max-h-[400px] overflow-y-auto">
                        ...
                        {messages.length === 0 ? (
                            <p className="text-gray-500 italic">No events yet. Try interacting with the game!</p>
                        ) : (
                            <ul className="list-none p-0 m-0">
                                {messages.map((msg, i) => (
                                    <li key={i} className="py-2 border-b border-gray-200 text-gray-800 last:border-none">
                                        {msg}
                                    </li>
                                ))}
                            </ul>
