...
import { Team, TeamRace } from '../../src/types/Team.js';
 ...
 */
export function createTestTeam(name: string = 'Test Team', race: TeamRace = TeamRace.HUMAN): Team {
