 ...
 */
export function createPronePlayer(
  teamId: string = "test-team",
  number: number = 1
): Player {
  return new PlayerBuilder()
 ...
 */
export function createStunnedPlayer(
  teamId: string = "test-team",
  number: number = 1
): Player {
  return new PlayerBuilder()
 ...
 */
export function createKOPlayer(
  teamId: string = "test-team",
  number: number = 1
): Player {
  return new PlayerBuilder()
