...
describe("Test Builders", () => {
  ...
  describe("PlayerBuilder", () => {
    it("should create a player with default values", () => {
      ...
      expect(player.positionName).toBe(PositionKeyWord.LINEMAN);
    ...
    it("should create a player with custom stats", () => {
      ...
      expect(player.positionName).toBe(PositionKeyWord.BLITZER);
      expect(player.stats.MA).toBe(7);
      expect(player.stats.ST).toBe(4);
      expect(player.number).toBe(5);
      expect(player.playerName).toBe("Big Hitter");
    });
...
describe("Test Fixtures", () => {
  describe("Team Fixtures", () => {
    it("should create a test team", () => {
      const team = createTestTeam("Test", RosterName.HUMAN);
  ...
  describe("Player Fixtures", () => {
    it("should create different player positions", () => {
      ...
      expect(lineman.positionName).toBe(PositionKeyWord.LINEMAN);
      expect(blitzer.positionName).toBe(PositionKeyWord.BLITZER);
      expect(catcher.positionName).toBe(PositionKeyWord.CATCHER);
