...
import { PlayerPlacementController } from "../../src/game/setup/PlayerPlacementController";
import { SetupValidator } from "../../src/game/setup/SetupValidator";
import { Pitch } from "../../src/game/Pitch";
import { Team, TeamRace } from "../../src/types/Team";
import { Player, PlayerPosition } from "../../src/types/Player";
...
describe("PlayerPlacementController", () => {
    ...
    beforeEach(() => {
        controller = new PlayerPlacementController(mockScene, mockPitch, mockValidator);
        ...
        team = {
            ...
            players: [
                { id: "p1", name: "Player 1", position: PlayerPosition.LINEMAN, teamId: "team-1", stats: { MA: 6, ST: 3, AG: 3, PA: 4, AV: 8 }, skills: [], baseStats: { MA: 6, ST: 3, AG: 3, PA: 4, AV: 8 }, spp: 0, level: 1, status: "Reserve" as any, injuries: [], hasActed: false, cost: 50000, number: 1 },
                { id: "p2", name: "Player 2", position: PlayerPosition.LINEMAN, teamId: "team-1", stats: { MA: 6, ST: 3, AG: 3, PA: 4, AV: 8 }, skills: [], baseStats: { MA: 6, ST: 3, AG: 3, PA: 4, AV: 8 }, spp: 0, level: 1, status: "Reserve" as any, injuries: [], hasActed: false, cost: 50000, number: 2 },
            ],
            maxRosterSize: 11,
            formations: [],
            treasury: 0,
